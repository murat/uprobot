defmodule UprobotWeb.UserControllerTest do
  use UprobotWeb.ConnCase

  alias Uprobot.Accounts

  @create_attrs %{confirmed_at: ~N[2010-04-17 14:00:00], email: "some email", locked_at: ~N[2010-04-17 14:00:00], password_digest: "some password_digest", reset_password_token_sent_at: ~N[2010-04-17 14:00:00]}
